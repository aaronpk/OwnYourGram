...
<div id="authorization_endpoint">
  ...
  <?php if($this->authorizationEndpoint): ?>
    <p>Found your authorization endpoint: <code><?= $this->authorizationEndpoint ?></code></p>
  <?php else: ?>
    <p>Could not find your authorization endpoint!</p>
...
<div id="token_endpoint">
  ...
  <?php if($this->tokenEndpoint): ?>
    <p>Found your token endpoint: <code><?= $this->tokenEndpoint ?></code></p>
  <?php else: ?>
    <p>Could not find your token endpoint!</p>
...
<div id="micropub_endpoint">
  ...
  <?php if($this->micropubEndpoint): ?>
    <p>Found your Micropub endpoint: <code><?= $this->micropubEndpoint ?></code></p>
  <?php else: ?>
    <p>Could not find your Micropub endpoint!</p>
