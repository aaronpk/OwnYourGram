...
<?php else: ?>
  ...
  <p>We didn't find a link to your website in your Instagram account, <b><code><?= $this->instagram_username ?></code></b>!</p>

  <p>You need to add a link to your website in your Instagram account. You can add it in either the "website" field or the "biography" fields. Make sure to add exactly this URL: <b><code><?= $this->user->url ?></code></b>.</p>
